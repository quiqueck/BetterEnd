...
public class InfusionCategory implements IRecipeCategory<RecipeHolder<InfusionRecipe>> {
    ...
    private static final ResourceLocation BACKGROUND = BetterEnd.C.mk("textures/gui/infusion.png");
    ...
    public void setRecipe(
        ...
        // InfusionRecipe.assemble() ignores both arguments, it just copies the output stack. On 26.1+
        // the HolderLookup.Provider parameter is gone from Recipe#assemble entirely.
        ItemStack output = recipe.assemble(null, null);
