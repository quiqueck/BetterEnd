...
public class CaveFeatureProvider extends WoverFeatureProvider {
    ...
    // 4..56" band is expressed with the raw vanilla HeightRangePlacement modifier. Top tracks
    // WoverEndConfig#DEFAULT_CAVE_BIOMES_TOP_Y and CarverProvider's ROUND_CAVE range (32 -> 56 -> 48, i.e.
    // this band's top 40 -> 64 -> 56), so decorations stay reachable throughout the actual carved band
    // without reaching above where the band was pulled back to avoid breaching island surfaces.
